...
terminal_theme_tools_string terminal_theme_tools_status_message(terminal_theme_tools_status status);

terminal_theme_tools_status terminal_theme_tools_context_create(
...
terminal_theme_tools_string terminal_theme_tools_context_last_error(
    const terminal_theme_tools_context *context);

size_t terminal_theme_tools_runner_count(const terminal_theme_tools_context *context);
terminal_theme_tools_status terminal_theme_tools_runner_find(
    terminal_theme_tools_context *context,
    const char *name,
    size_t *out_index);
terminal_theme_tools_string terminal_theme_tools_runner_name(
    const terminal_theme_tools_context *context,
    size_t runner_index);
size_t terminal_theme_tools_runner_alias_count(
    const terminal_theme_tools_context *context,
    size_t runner_index);
terminal_theme_tools_string terminal_theme_tools_runner_alias(
    const terminal_theme_tools_context *context,
    size_t runner_index,
    size_t alias_index);
size_t terminal_theme_tools_runner_program_count(
    const terminal_theme_tools_context *context,
    size_t runner_index);
terminal_theme_tools_string terminal_theme_tools_runner_program(
    const terminal_theme_tools_context *context,
    size_t runner_index,
    size_t program_index);
terminal_theme_tools_string terminal_theme_tools_runner_integration(
    const terminal_theme_tools_context *context,
    size_t runner_index);
terminal_theme_tools_string terminal_theme_tools_runner_interpreter(
    const terminal_theme_tools_context *context,
    size_t runner_index);

size_t terminal_theme_tools_integration_count(const terminal_theme_tools_context *context);
terminal_theme_tools_string terminal_theme_tools_integration_name(
    const terminal_theme_tools_context *context,
    size_t integration_index);
terminal_theme_tools_integration_strategy terminal_theme_tools_integration_strategy_at(
    const terminal_theme_tools_context *context,
    size_t integration_index);
terminal_theme_tools_string terminal_theme_tools_integration_theme(
    const terminal_theme_tools_context *context,
    size_t integration_index,
    terminal_theme_tools_theme theme);

size_t terminal_theme_tools_interpreter_count(const terminal_theme_tools_context *context);
terminal_theme_tools_string terminal_theme_tools_interpreter_name(
    const terminal_theme_tools_context *context,
    size_t interpreter_index);
size_t terminal_theme_tools_interpreter_program_count(
    const terminal_theme_tools_context *context,
    size_t interpreter_index);
terminal_theme_tools_string terminal_theme_tools_interpreter_program(
    const terminal_theme_tools_context *context,
    size_t interpreter_index,
    size_t program_index);

terminal_theme_tools_theme terminal_theme_tools_parse_terminal_report(
    const uint8_t *bytes,
    size_t length);
terminal_theme_tools_theme terminal_theme_tools_theme_from_text(
    const terminal_theme_tools_context *context,
    const uint8_t *bytes,
    size_t length);
terminal_theme_tools_theme terminal_theme_tools_detect_theme(
    terminal_theme_tools_context *context);
...
terminal_theme_tools_status terminal_theme_tools_prepare(
    terminal_theme_tools_context *context,
    const char *command,
...
terminal_theme_tools_string terminal_theme_tools_command_argument(
    const terminal_theme_tools_command *command,
    size_t argument_index);
terminal_theme_tools_string terminal_theme_tools_command_environment(
    const terminal_theme_tools_command *command,
    const char *name);
terminal_theme_tools_string terminal_theme_tools_command_temporary_path(
    const terminal_theme_tools_command *command);
terminal_theme_tools_status terminal_theme_tools_command_execute(
    terminal_theme_tools_command *command,
