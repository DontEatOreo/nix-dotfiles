...
Each child directory represents one package and keeps its build definitions,
tests, and generated inputs in one place.
...
- Product code and build logic kept separate from machine and user
  configuration.
